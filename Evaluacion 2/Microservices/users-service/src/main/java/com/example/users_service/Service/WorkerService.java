...
import com.example.users_service.Repository.WorkerRepository;
...
public class WorkerService {
    ...
    public WorkerEntity getWorkerByMail(String mail) {
        return workerRepo.findByMail(mail)
                .orElseThrow(() -> new EntityNotFoundException("No existe el usuario con el mail: " + mail));
    }

    public WorkerEntity getWorkerByName(String name) {
        return workerRepo.findByNameIgnoreCase(name)
                .orElseThrow(() -> new EntityNotFoundException("No existe el usuario con el nombre: " + name));
    }
